...
class BackendFunction(Protocol):
    ...
    transformations (such as :code:`jax.jit`, :code:`jax.grad`, or :code:`jax.vmap`) can
    be applied to it and estimators can determine which computational backend to use.
