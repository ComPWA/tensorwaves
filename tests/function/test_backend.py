...
def describe_find_function():
    def it_finds_jax_numpy_functions():
    ...
    def it_falls_back_to_numpy_for_numba():
        import numpy as np

        assert find_function("mean", backend="numba") is np.mean

    def it_finds_tensorflow_functions():
